...
<main class="relative">
    <div id="single-product" class="container">
        <div class="w-full flex flex-col md:flex-row justify-between">
            <div class="w-full md:w-[300px] lg:w-[517px] xl:w-[595px]">
                <!-- PRODUCT AFBEELDING -->
                    <?php
                    global $product;
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <?php
                                            ...
                                            if ( $product->get_gallery_image_ids() ) {
                                                ...
                                                foreach ( $gallery_image_ids as $image_id ) { 
                                                    $image_url = wp_get_attachment_url($image_id); ?>
                                                    <div class="swiper-slide aspect-[16/12] w-full bg-[#F9F9F9] flex justify-center">
                                                        <img src="<?php echo esc_url($image_url);?>" alt="" class="min-w-full min-h-full object-cover object-center mix-blend-multiply">
                                                    </div>
                                                <?php
                                                }
            ...
            <div class="w-full h-auto md:w-[359px] lg:w-[535px] xl:w-[605px] relative">
                <div class="sticky top-[108px] xl:top-[123px] md:min-h-[616px] lg:min-h-[519px] xl:min-h-[597px] flex flex-col justify-between">
                    <div class="">
                        <div class="flex items-start mt-[30px] md:mt-[25px] lg:mt-[60px] xl:mt-[75px] justify-between">
                        ...
                        <?php if (get_the_excerpt()): ?>
                            <div class="mt-[15px] md:mt-[35px] xl:mt-[40px]">
                        ...
                        <div class="grid grid-cols-7 w-[350px] items-center">
                            <div class="h-[28px] w-[28px] rounded-full bg-white border-[1px] border-[#000] flex justify-center items-center">
                                <div class="h-[24px] w-[24px] rounded-full block" style="background:<?php the_field('colour', get_the_ID());?>;"></div>
                            </div>
                            ...
                            if ($related_products->have_posts()) :
                                while ($related_products->have_posts()) : $related_products->the_post();  // Informatie over het product ophalen
                                        ...
                                        <a href="<?php the_permalink(); ?>" class="h-[24px] w-[24px] rounded-full block" style="background:<?php the_field('colour', get_the_ID());?>;"></a>
                                <?php endwhile;
                            endif;
                            wp_reset_postdata();
                            ?>
                    ...
                    <div class="">
                        ...
                        <!-- PRODUCT TOEVOEGEN -->
                        <div class="pt-3 flex flex-col lg:flex-row w-full">
                            <?php
                            global $product;
