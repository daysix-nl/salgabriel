...
?>
<div id="payment" class="woocommerce-checkout-payment paybox mt-[45px]">
	<?php if ( WC()->cart->needs_payment() ) : ?>
		
		<ul class="wc_payment_methods payment_methods methods">
			<h2 class="font-jost font-semibold text-15 leading-25 xl:text-17 xl:leading-25 tracking-[0.05em] uppercase">Payment</h2>
