...
<footer>
    ...
    <section class="bg-[#F6F6F4] py-[60px] md:py-[80px] lg:py-[75px] xl:py-[85px]">
        <div class="container md:flex md:flex-wrap lg:flex-nowrap justify-between">
            <div class="md:w-[244px] lg:w-[180px] md:order-2 lg:order-1 h-fit hidden md:block">
                ...
                <div class="w-[101px]  grid-cols-4 mt-[35px] md:mt-[50px] hidden lg:grid">
                    <a href="https://www.instagram.com/salgabrielco" class="h-[15px] xl:h-[17px] hoveropacity" target="_blank">
                    ...
                    <a href="https://www.tiktok.com/@salgabrielgames" class="h-[15px] xl:h-[17px] hoveropacity" target="_blank">
            ...
            <div class="md:w-[244px] lg:w-[180px] md:order-4 lg:order-2 md:mt-[25px] lg:mt-[unset] h-fit hidden md:block">
                <h3 class="font-syne font-bold text-14 leading-22 tracking-[0.06em] text-[#000] uppercase mb-[20px] xl:mb-[25px]">Support</h3>
                <div class="grid h-fit">
                    <a href="/faq/" class="hoveropacity font-jost font-normal text-15 leading-26 xl:text-16 xl:leading-30 tracking-[0.02em] text-[#121212] w-fit">FAQ</a>
                    <a href="/care/" class="hoveropacity font-jost font-normal text-15 leading-26 xl:text-16 xl:leading-30 tracking-[0.02em] text-[#121212] w-fit">Care</a>
                    <a href="/shipping-and-returns/" class="hoveropacity font-jost font-normal text-15 leading-26 xl:text-16 xl:leading-30 tracking-[0.02em] text-[#121212] w-fit">Shipping & Returns</a>
                    <a href="/contact/" class="hoveropacity font-jost font-normal text-15 leading-26 xl:text-16 xl:leading-30 tracking-[0.02em] text-[#121212] w-fit">Contact</a>
                </div>
            </div>
            <div class="md:w-[307px] lg:w-[180px] md:order-3 md:mt-[40px] lg:mt-[unset] h-fit hidden md:block">
                <h3 class="font-syne font-bold text-14 leading-22 tracking-[0.06em] text-[#000] uppercase mb-[20px] xl:mb-[25px]">Legal</h3>
                <div class="grid h-fit">
                    <a href="/privacy-policy/" class="hoveropacity font-jost font-normal text-15 leading-26 xl:text-16 xl:leading-30 tracking-[0.02em] text-[#121212] w-fit">Privacy Policy</a>
                    <a href="/terms-and-conditions/" class="hoveropacity font-jost font-normal text-15 leading-26 xl:text-16 xl:leading-30 tracking-[0.02em] text-[#121212] w-fit">Terms and Conditions</a>
                </div>
            </div>
            <div class="md:w-[307px] lg:w-[405px] md:order-1 lg:order-4">
                <h3 class="font-syne font-bold text-14 leading-22 tracking-[0.06em] text-[#000] uppercase mb-[20px] xl:mb-[25px]">Get the latest news</h3>
                <p class="font-jost font-normal text-15 leading-26 xl:text-16 xl:leading-30 tracking-[0.02em] text-[#121212] md:max-w-[300px] lg:max-w-[unset]">Sign up to our newsletter and stay up-to-date. </p>
                <div class="newsletter mt-[20px] max-w-[405px]">
                     <?php echo do_shortcode('[gravityform id="2" title="false"]'); ?>
                </div>
                <p class="hidden lg:block font-jost font-normal text-10 leading-22 xl:text-11 xl:leading-22 tracking-[0.02em] text-[#121212] md:max-w-[300px] lg:max-w-[351px] mt-[20px]">I have read and understood Sal Gabriel’s Privacy Policy and I agree to receive the newsletter and other marketing communication.</p>
            </div>
            <div class="md:hidden mt-[30px]">
                <div class="w-full footermobile">
                    <div class="accordion-item"> 
                        <button class="accordion font-syne font-bold text-14 leading-22 tracking-[0.06em] text-[#000] uppercase pr-2 md:pr-3 lg:pr-4 py-2">
                            <span class="pr-4">Explore</span>
                        </button>
                        <div class="panel">
                    ...
                    <div class="accordion-item"> 
                        <button class="accordion font-syne font-bold text-14 leading-22 tracking-[0.06em] text-[#000] uppercase pr-0 md:pr-2 lg:pr-3 py-2">
                            <span class="pr-4">Legal</span>
                        </button>
                        <div class="panel">
                            <div class="pb-3 pr-2 md:pb-4 md:pr-3 lg:pb-4  lg:pr-4">
                               <div class="grid h-fit">
                    ...
                    <div class="w-[121px] grid grid-cols-4 mt-[35px] md:mt-[50px] md:hidden gap-[10px]">
                    <a href="https://www.instagram.com/salgabrielco" class="h-[20px] xl:h-[17px] hoveropacity" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="auto" height="100%" viewBox="0 0 17.053 17.053">
                            <g id="instagram-svgrepo-com" transform="translate(-1 -1)">
                                <path id="Path_587" data-name="Path 587" d="M10.651,15.3A4.651,4.651,0,1,0,6,10.651,4.651,4.651,0,0,0,10.651,15.3Zm0-1.55a3.1,3.1,0,1,0-3.1-3.1A3.1,3.1,0,0,0,10.651,13.751Z" transform="translate(-1.124 -1.124)" fill="#121212" fill-rule="evenodd"/>
                                <path id="Path_588" data-name="Path 588" d="M17.775,5a.775.775,0,1,0,.775.775A.775.775,0,0,0,17.775,5Z" transform="translate(-3.598 -0.899)" fill="#121212"/>
                    ...
                    <a href="https://www.tiktok.com/@salgabrielgames" class="h-[20px] xl:h-[17px] hoveropacity" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="auto" height="100%" viewBox="0 0 14.773 17">
                            <path id="tiktok-svgrepo-com" d="M10.729,1.018C11.657,1,12.578,1.011,13.5,1A4.4,4.4,0,0,0,14.74,3.959h0a4.972,4.972,0,0,0,2.988,1.267h.016V8.082a7.555,7.555,0,0,1-3.022-.707l.046.019a8.722,8.722,0,0,1-1.178-.678l.029.019c-.007,2.069.007,4.137-.014,6.2a5.393,5.393,0,0,1-.968,2.809l.011-.018A5.281,5.281,0,0,1,8.47,18H8.462c-.07,0-.152.005-.235.005a5.143,5.143,0,0,1-2.679-.748l.023.013a5.355,5.355,0,0,1-2.584-4.022l0-.023c-.014-.354-.021-.709-.007-1.056A5.339,5.339,0,0,1,8.285,7.363a5.4,5.4,0,0,1,.909.077l-.032,0c.014,1.048-.028,2.1-.028,3.145a2.388,2.388,0,0,0-.805-.137,2.432,2.432,0,0,0-2.293,1.622l-.005.017a2.751,2.751,0,0,0-.119.808,2.9,2.9,0,0,0,.021.346v-.014a2.415,2.415,0,0,0,2.382,2.035l.1,0H8.411a2.38,2.38,0,0,0,1.956-1.13l.006-.01a1.62,1.62,0,0,0,.29-.743v-.008c.071-1.268.043-2.529.049-3.8.007-2.855-.007-5.7.014-8.551Z" transform="translate(-2.97 -1.004)" fill="#121212"/>
                        </svg>
                    </a>
