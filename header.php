...
<section class="h-[30px] md:h-[35px] bg-black w-full items-center justify-center flex">
    <p class="font-jost font-normal text-12 leading-12 xl:text-13 xl:leading-13 text-white hidden md:block">Holiday Update: Pick-up available in Amsterdam & Rotterdam. Email <a href="mailto:contact@salgabriel.com">contact@salgabriel.com</a> </p>
    <p class="font-jost font-normal text-12 leading-12 xl:text-13 xl:leading-13 text-white md:hidden">Holiday Update: Pick-up available in Amsterdam & Rotterdam.</p>
</section>
