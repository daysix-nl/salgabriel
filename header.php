...
<section class="h-[30px] md:h-[35px] bg-black w-full items-center justify-center flex">
    <p class="font-jost font-normal text-12 leading-12 xl:text-13 xl:leading-13 text-white hidden md:block">Free shipping*</p>
    <p class="font-jost font-normal text-12 leading-12 xl:text-13 xl:leading-13 text-white md:hidden">Free shipping*</p>
</section>
